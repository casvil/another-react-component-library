import{j as l}from"./jsx-runtime-D_zvdyIk.js";import{r as _}from"./iframe-K6es8UjJ.js";import{c as m}from"./clsx-B-dksMZM.js";import{L as E}from"./Label-BnpzQARg.js";import{u as B}from"./useStableId-BQAh0rnB.js";import{i as O}from"./size-BIjEKicz.js";import{W as V}from"./WithFullWidthRoot-CH8aBl7Z.js";const i=_.forwardRef(({label:n,labelPosition:q="above",wrapperClassName:j,labelClassName:A,size:F="md",id:R,className:D,...I},M)=>{const d=B(R),P=q==="beside"?"flex-row":"flex-col";return l.jsxs("div",{className:m("flex gap-2",P,j),children:[n&&l.jsx(E,{htmlFor:d,className:A,children:n}),l.jsx("textarea",{id:d,ref:M,className:m("resize-none rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500",O[F],D),...I})]})});i.displayName="TextArea";i.__docgenInfo={description:`TextArea molecule component.
