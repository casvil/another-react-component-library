import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{r as c}from"./iframe-DtmuWCxD.js";import{c as p}from"./clsx-B-dksMZM.js";import{L as V}from"./Label-BnpzQARg.js";const L=c.forwardRef(({id:j,label:i,className:A,labelClassName:E,wrapperClassName:_,...I},O)=>{const l=j||c.useId(),d=n.jsx("input",{id:l,type:"radio",ref:O,className:p("h-4 w-4 text-indigo-600 focus:ring-2 focus:ring-indigo-500 border-gray-300 rounded-full",A),...I});return i?n.jsxs("div",{className:p("flex items-center space-x-2",_),children:[d,n.jsx(V,{className:E,htmlFor:l,children:i})]}):d});L.__docgenInfo={description:`Radio atom component.
