import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{c as m}from"./clsx-B-dksMZM.js";import{B}from"./Badge-DXMWmY3a.js";import{A as S}from"./Avatar-BfDUxCA5.js";import"./iframe-DpnjE_u6.js";const A=({avatarProps:f,badgeProps:a,children:n,className:N,textClassName:h})=>{const e={size:"sm",...f};return o.jsxs(B,{...a,className:m("inline-flex items-center space-x-1 rounded-full",N,a==null?void 0:a.className),"aria-label":(a==null?void 0:a["aria-label"])||String(n)||e.alt||e.name||"User avatar",children:[o.jsx(S,{...e,className:m("rounded-full",e.className)}),n&&o.jsx("span",{className:h,children:n})]})};A.__docgenInfo={description:`BadgeAvatar molecule.
