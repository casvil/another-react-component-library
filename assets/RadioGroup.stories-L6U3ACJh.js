import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{R as y}from"./iframe-Bmn3l3Ky.js";import{c as ue}from"./clsx-B-dksMZM.js";import{L as de}from"./Label-BnpzQARg.js";import{R as ce}from"./Radio-CjEo5PLB.js";import{u as pe}from"./useStableId-D36wOgNH.js";import"./size-5-yVhG49.js";const g=({label:a,options:b,value:l,defaultValue:Q,onChange:v,name:X,direction:Z="vertical",className:ee,labelClassName:ae,radioProps:re})=>{const f=l!==void 0,[le,oe]=y.useState(Q??""),se=f?l:le,h=pe(X),S=a?`${h}-label`:void 0,ne=y.useCallback(e=>ie=>{ie.target.checked&&(f||oe(e),v&&v(e))},[f,v]),te=Z==="vertical"?"flex-col gap-2":"flex-row gap-4";return r.jsxs("div",{className:ee,role:"radiogroup","aria-labelledby":S,children:[a&&r.jsx(de,{id:S,className:ae,children:a}),r.jsx("div",{className:ue("flex",te),children:b.map(e=>r.jsx(ce,{label:e.label,checked:se===e.value,onChange:ne(e.value),name:h,value:e.value,disabled:e.disabled,...re},e.value))})]})};g.displayName="RadioGroup";g.__docgenInfo={description:`RadioGroup molecule component.
