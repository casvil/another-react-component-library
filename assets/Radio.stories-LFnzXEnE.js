import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{r as O}from"./iframe-plP9v_Vp.js";import{c}from"./clsx-B-dksMZM.js";import{L as V}from"./Label-BnpzQARg.js";import{u as B}from"./useStableId-D551v5Ku.js";const D=O.forwardRef(({id:L,label:i,className:j,labelClassName:A,wrapperClassName:E,..._},I)=>{const l=B(L),d=n.jsx("input",{id:l,type:"radio",ref:I,className:c("h-4 w-4 text-indigo-600 focus:ring-2 focus:ring-indigo-500 border-gray-300 rounded-full",j),..._});return i?n.jsxs("div",{className:c("flex items-center space-x-2",E),children:[d,n.jsx(V,{className:A,htmlFor:l,children:i})]}):d});D.__docgenInfo={description:`Radio atom component.
