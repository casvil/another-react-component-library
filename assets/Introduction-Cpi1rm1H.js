import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as t}from"./index-ZZc7ZPca.js";import{M as a}from"./blocks-j6TxuQ6N.js";import"./Button-CZFgrRDI.js";import"./Input-DKYYlWbW.js";import"./Badge-DEKmEavr.js";import{F as i,a as o}from"./Form-B6sbctC0.js";import{S as c}from"./Select-DfCjuAGw.js";import{S as d}from"./Switch-DUVN_rlA.js";import{C as h}from"./Clock-DRNHfnkC.js";import"./iframe-BbYVxIeR.js";import"./index-b9pfhHNd.js";import"./clsx-B-dksMZM.js";import"./classes-zVeSqKhV.js";import"./FormField-C_kxw0qP.js";import"./createLucideIcon-CdlKAxmU.js";import"./Label-DmQWfZIS.js";import"./Tooltip-BZva5cr3.js";import"./useStableId-NxHCH-Z3.js";import"./ErrorMessage-B1DJFAfK.js";import"./TimeDisplay-BGp_n2q0.js";function s(n){const r={a:"a",br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{title:"Introduction"}),`
...
`,e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px",padding:"16px",border:"1px solid #e5e7eb",borderRadius:"8px",backgroundColor:"#f9fafb"},children:[e.jsx("div",{style:{display:"flex",justifyContent:"center"},children:e.jsx(h,{format:"HH:mm:ss",bordered:!0})}),e.jsx("div",{children:e.jsxs(i,{onSubmit:l=>alert(JSON.stringify(l,null,2)),children:[e.jsx(o,{name:"username",label:"Username",placeholder:"Enter your username",required:!0}),e.jsx(c,{label:"Favorite Fruit",options:[{value:"apple",label:"🍎 Apple"},{value:"banana",label:"🍌 Banana"},{value:"orange",label:"🍊 Orange"},{value:"grape",label:"🍇 Grape"}],defaultValue:"apple"}),e.jsx(d,{label:"Enable notifications",defaultChecked:!0,wrapperClassName:"space-x-6"})]})})]}),`
...
`,e.jsxs(r.li,{children:[e.jsx(r.strong,{children:e.jsx(r.a,{href:"?path=/story/atoms-alert--default",children:"Alert"})})," - Alert and notification messages"]}),`
...
`,e.jsxs(r.li,{children:[e.jsx(r.strong,{children:e.jsx(r.a,{href:"?path=/story/atoms-card--default",children:"Card"})})," - Content containers with variants"]}),`
...
`,e.jsxs(r.li,{children:[e.jsx(r.strong,{children:e.jsx(r.a,{href:"?path=/story/atoms-errorboundary--default",children:"ErrorBoundary"})})," - Error boundary"]}),`
...
`,e.jsxs(r.li,{children:[e.jsx(r.strong,{children:e.jsx(r.a,{href:"?path=/story/atoms-layout-box--playground",children:"Layout/Box"})})," - Generic wrapper with spacing, sizing, border, and shadow props for custom layouts."]}),`
`,e.jsxs(r.li,{children:[e.jsx(r.strong,{children:e.jsx(r.a,{href:"?path=/story/atoms-layout-stack--playground",children:"Layout/Stack"})})," - Flexbox stack for vertical or horizontal arrangement with consistent gap and alignment."]}),`
`,e.jsxs(r.li,{children:[e.jsx(r.strong,{children:e.jsx(r.a,{href:"?path=/story/atoms-layout-flex--playground",children:"Layout/Flex"})})," - Low-level flexbox wrapper with full control over direction, alignment, gap, and wrap."]}),`
`,e.jsxs(r.li,{children:[e.jsx(r.strong,{children:e.jsx(r.a,{href:"?path=/story/atoms-layout-grid--playground",children:"Layout/Grid"})})," - CSS grid wrapper for responsive, multi-column layouts with gap and alignment."]}),`
`,e.jsxs(r.li,{children:[e.jsx(r.strong,{children:e.jsx(r.a,{href:"?path=/story/atoms-layout-container--playground",children:"Layout/Container"})})," - Responsive max-width wrapper for page sections, with centering and padding."]}),`
`,e.jsxs(r.li,{children:[e.jsx(r.strong,{children:e.jsx(r.a,{href:"?path=/story/atoms-layout-spacer--playground",children:"Layout/Spacer"})})," - Flexible gap filler for vertical space or flex grow in layouts."]}),`
...
`,e.jsxs(r.li,{children:[e.jsx(r.strong,{children:e.jsx(r.a,{href:"?path=/story/atoms-tabledata--default",children:"TableData"})})," - Table data cells with formatting"]}),`
`,e.jsxs(r.li,{children:[e.jsx(r.strong,{children:e.jsx(r.a,{href:"?path=/story/atoms-tableheader--default",children:"TableHeader"})})," - Table header cells with sorting"]}),`
`,e.jsxs(r.li,{children:[e.jsx(r.strong,{children:e.jsx(r.a,{href:"?path=/story/atoms-tablerow--default",children:"TableRow"})})," - Table rows with variants"]}),`
`,e.jsxs(r.li,{children:[e.jsx(r.strong,{children:e.jsx(r.a,{href:"?path=/story/atoms-text--default",children:"Text"})})," - Typography component"]}),`
...
`,e.jsxs(r.li,{children:[e.jsx(r.strong,{children:e.jsx(r.a,{href:"?path=/story/molecules-dropzone--default",children:"DropZone"})})," - File upload with drag & drop functionality"]}),`
...
`]}),`
`,e.jsx(r.h3,{id:"-organisms",children:"🔬 Organisms"}),`
`,e.jsxs(r.ul,{children:[`
`,e.jsxs(r.li,{children:[e.jsx(r.strong,{children:e.jsx(r.a,{href:"?path=/docs/organisms-table--docs",children:"Table"})})," - Complete data table with sorting and responsive design"]}),`
`]}),`
...
`,e.jsx(r.strong,{children:"React:"})," 18+ or 19+ | ",e.jsx(r.strong,{children:"Dependencies:"})," Tailwind CSS v4, Lucide React, clsx"]})]})}function E(n={}){const{wrapper:r}={...t(),...n.components};return r?e.jsx(r,{...n,children:e.jsx(s,{...n})}):s(n)}export{E as default};
