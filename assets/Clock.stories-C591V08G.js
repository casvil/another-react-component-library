import{j as D}from"./jsx-runtime-D_zvdyIk.js";import{C as d}from"./Clock-BzSjL58N.js";import"./iframe-q8_L0F5O.js";import"./TimeDisplay-BeEuADz9.js";import"./clsx-B-dksMZM.js";const O={title:"molecules/Clock",component:d,tags:["autodocs"],parameters:{layout:"centered"},argTypes:{format:{control:"select",options:["HH:mm:ss","HH:mm","mm:ss"]},bordered:{control:"boolean"},className:{control:!1}}},r={args:{format:"HH:mm:ss",bordered:!1}},e={args:{format:"HH:mm:ss",bordered:!0}},s={args:{format:"HH:mm",bordered:!1}},o={args:{format:"mm:ss",bordered:!1}},a={render:m=>D.jsx(d,{...m,className:"digital7 text-4xl border-3 px-3 py-0"}),args:{format:"mm:ss",bordered:!0}},t={render:m=>D.jsx(d,{...m,className:"digital7 text-4xl border-3 px-3 py-0"}),args:{format:"mm:ss",bordered:!0,stop:!0}};var c,n,p;r.parameters={...r.parameters,docs:{...(c=r.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    format: 'HH:mm:ss',
    bordered: false
  }
