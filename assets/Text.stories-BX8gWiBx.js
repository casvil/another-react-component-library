import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as ae,r as ne}from"./iframe-By2cKsV2.js";import{c as ie}from"./clsx-B-dksMZM.js";import{l as n,m as re}from"./classes-BD7lNhBs.js";const se={h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",h6:"h6",body:"p",small:"small",caption:"span"},t=ae.memo(ne.forwardRef(({children:a,variant:p="body",weight:u,color:O="primary",align:G="left",truncate:K=!1,className:Q,as:X,...Y},Z)=>{const $=X||se[p],ee=u?n.weight[u]:n.variantDefaultWeights[p],te=ie(n.variant[p],ee,n.color[O],re[G],{truncate:K},Q);return e.jsx($,{ref:Z,className:te,...Y,children:a})}));t.displayName="Text";t.__docgenInfo={description:`Text atom component. A flexible typography component for rendering text with various styles.
...
}`,...(E=(M=l.parameters)==null?void 0:M.docs)==null?void 0:E.source}}};var F,R,I;c.parameters={...c.parameters,docs:{...(F=c.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => <div className="space-y-4">
      <div>
...
}`,...(I=(R=c.parameters)==null?void 0:R.docs)==null?void 0:I.source}}};var q,B,L;d.parameters={...d.parameters,docs:{...(q=d.parameters)==null?void 0:q.docs,source:{originalSource:`{
...
}`,...(z=(k=x.parameters)==null?void 0:k.docs)==null?void 0:z.source}}};const me=["Default","Headings","BodyTexts","Colors","Weights","Alignments","Truncated","CustomElements","SemanticExample","AllVariants"];export{c as Alignments,x as AllVariants,s as BodyTexts,o as Colors,h as CustomElements,i as Default,r as Headings,m as SemanticExample,d as Truncated,l as Weights,me as __namedExportsOrder,he as default};
