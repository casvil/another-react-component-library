import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as C}from"./iframe-Ds_X6DKR.js";import{F as m,a}from"./Form-Cndht0II.js";import{B as w}from"./Button-ukBVQVn2.js";import{B as S}from"./Badge-DtN_85IE.js";import{D as d}from"./Divider-DaxDipJi.js";import{U as ie}from"./UserPreview-CozwSX6J.js";import{T as ne}from"./TextArea-CwW543bl.js";import{S as u}from"./Switch-DD_mSkj9.js";import{F as oe}from"./FormField-B10A5keA.js";import{S as me}from"./Select-SFneh2Yz.js";import{R as le}from"./RadioGroup-B5hj6E6g.js";import{C as ce}from"./CheckboxGroup-DfdN-1TX.js";import{M as c,L as j}from"./mail-BVGy8POk.js";import{U as r}from"./user-DhsrxJAK.js";import{c as P}from"./createLucideIcon-5dodZkuP.js";import"./clsx-B-dksMZM.js";import"./ErrorMessage-B1DJFAfK.js";import"./size-DtCGJLJt.js";import"./Avatar-DpzQ1iol.js";import"./Username-B1t3AxF7.js";import"./StatusIndicator-DAKbbgAj.js";import"./Label-BnpzQARg.js";import"./useStableId-DYXkd8vM.js";import"./Input-DqEeptCX.js";import"./Tooltip-B_rdbyG5.js";import"./Radio-BYKUym4D.js";import"./Checkbox-CCsiMEzB.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pe=[["path",{d:"M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384",key:"9njp5v"}]],q=P("phone",pe),Ve={title:"Molecules/Form",component:m,parameters:{layout:"centered",actions:{handles:["onSubmit","onValidate","onFieldChange","onFieldBlur"]}},tags:["autodocs"],argTypes:{layout:{control:"select",options:["vertical","horizontal","grid"]},spacing:{control:"select",options:["sm","md","lg"]},gridColumns:{control:{type:"number",min:1,max:4}},onSubmit:{action:"form-submitted"},onValidate:{action:"form-validated"},onFieldChange:{action:"field-changed"},onFieldBlur:{action:"field-blurred"},validateOnChange:{control:"boolean",description:"Validate fields as the user types"},validateOnBlur:{control:"boolean",description:"Validate fields when they lose focus"},validateOnSubmit:{control:"boolean",description:"Validate the entire form before submission"},resetOnSubmit:{control:"boolean",description:"Reset the form after successful submission"},disabled:{control:"boolean",description:"Disable the entire form"},className:{control:"text",description:"Additional CSS classes for the form"}}},p={args:{onSubmit:()=>{}},render:()=>{const t=async l=>{alert(`Form submitted! Check console for detailed logs.

Data: ${JSON.stringify(l,null,2)}`)};return e.jsx("div",{className:"w-96",children:e.jsxs(m,{onSubmit:t,children:[e.jsx(a,{name:"email",label:"Email Address",type:"email",icon:c,placeholder:"Enter your email",tooltip:"We'll never share your email with anyone",required:!0}),e.jsx(a,{name:"password",label:"Password",type:"password",icon:j,placeholder:"Enter your password",tooltip:"Must be at least 8 characters",required:!0,validate:l=>{if(l&&l.length<8)return"Password must be at least 8 characters"}})]})})}},h={args:{onSubmit:()=>{},onValidate:()=>{}},render:t=>{const l=async o=>{const s={};return t.onValidate(o),o.email==="taken@example.com"&&(s.email="This email is already taken"),o.password!==o.confirmPassword&&(s.confirmPassword="Passwords do not match"),s},i=async(o,s)=>{try{t.onSubmit(o,s),await new Promise(n=>setTimeout(n,2e3)),console.log("Registration successful:",o),alert("Registration successful!"),s.reset()}catch{s.setErrors({form:"Registration failed. Please try again."})}};return e.jsx("div",{className:"w-96",children:e.jsxs(m,{onSubmit:i,onValidate:l,validateOnBlur:!0,submitText:"Register",loadingText:"Creating account...",children:[e.jsx(a,{name:"firstName",label:"First Name",icon:r,placeholder:"John",required:!0}),e.jsx(a,{name:"lastName",label:"Last Name",icon:r,placeholder:"Doe",required:!0}),e.jsx(a,{name:"email",label:"Email Address",type:"email",icon:c,placeholder:"john@example.com",tooltip:"Try 'taken@example.com' to see validation error",required:!0}),e.jsx(a,{name:"password",label:"Password",type:"password",icon:j,placeholder:"••••••••",tooltip:"Must be at least 8 characters with numbers",required:!0,validate:o=>{if(o){if(o.length<8)return"Password must be at least 8 characters";if(!/\d/.test(o))return"Password must contain at least one number"}}}),e.jsx(a,{name:"confirmPassword",label:"Confirm Password",type:"password",icon:j,placeholder:"••••••••",tooltip:"Must match your password",required:!0})]})})}},b={render:()=>{const t=async l=>{console.log("Contact form submitted:",l),alert("Message sent successfully!")};return e.jsx("div",{className:"w-full max-w-2xl",children:e.jsxs(m,{onSubmit:t,layout:"grid",gridColumns:2,spacing:"lg",submitText:"Send Message",children:[e.jsx(a,{name:"firstName",label:"First Name",icon:r,placeholder:"John",required:!0}),e.jsx(a,{name:"lastName",label:"Last Name",icon:r,placeholder:"Doe",required:!0}),e.jsx(a,{name:"email",label:"Email",type:"email",icon:c,placeholder:"john@example.com",tooltip:"We'll respond to this email",required:!0}),e.jsx(a,{name:"phone",label:"Phone",type:"tel",icon:q,placeholder:"+1 (555) 123-4567",tooltip:"Optional: For urgent matters"}),e.jsx("div",{className:"col-span-2",children:e.jsx(oe,{label:"Message",name:"message",tooltip:"Tell us how we can help you",placeholder:"Your message here...",required:!0})})]})})}},g={render:()=>{const t=async l=>{console.log("Search submitted:",l)};return e.jsx("div",{className:"w-full",children:e.jsxs(m,{onSubmit:t,layout:"horizontal",spacing:"sm",submitText:"Search",children:[e.jsx(a,{name:"query",label:"Search",placeholder:"Enter search terms...",tooltip:"Search across all products",className:"min-w-64"}),e.jsx(a,{name:"category",label:"Category",placeholder:"All categories",tooltip:"Filter by category",className:"min-w-40"})]})})}},v={render:()=>{const[t,l]=C.useState({username:"john_doe",email:"john@example.com"}),i=async s=>{l(s),console.log("Updated data:",s)},o=(s,n)=>{console.log(`Field ${s} changed to:`,n)};return e.jsxs("div",{className:"w-96 space-y-4",children:[e.jsxs("div",{className:"p-4 bg-gray-50 rounded-lg",children:[e.jsx("h3",{className:"font-semibold mb-2",children:"Current Form Data:"}),e.jsx("pre",{className:"text-sm text-gray-600",children:JSON.stringify(t,null,2)})]}),e.jsxs(m,{onSubmit:i,initialValues:t,onFieldChange:o,validateOnChange:!0,submitText:"Update Profile",children:[e.jsx(a,{name:"username",label:"Username",icon:r,placeholder:"Enter username",tooltip:"Must be unique and 3+ characters",required:!0,validate:s=>{if(s){if(s.length<3)return"Username must be at least 3 characters";if(!/^[a-zA-Z0-9_]+$/.test(s))return"Username can only contain letters, numbers, and underscores"}}}),e.jsx(a,{name:"email",label:"Email",type:"email",icon:c,placeholder:"Enter email",tooltip:"We'll send notifications here",required:!0}),e.jsx(a,{name:"bio",label:"Bio",placeholder:"Tell us about yourself...",tooltip:"Optional: Share a bit about yourself"})]})]})}},f={render:()=>{const[t,l]=C.useState(!1),i=async o=>{l(!0),await new Promise(s=>setTimeout(s,2e3)),l(!1),console.log("Custom submit:",o),alert("Custom submission complete!")};return e.jsx("div",{className:"w-96",children:e.jsxs(m,{onSubmit:i,isSubmitting:t,showSubmitButton:!1,children:[e.jsx(a,{name:"title",label:"Post Title",placeholder:"Enter title",required:!0}),e.jsx(a,{name:"content",label:"Content",placeholder:"Write your post...",required:!0}),e.jsxs("div",{className:"flex gap-2 pt-2",children:[e.jsx(w,{type:"submit",label:t?"Publishing...":"Publish Post",disabled:t,variant:"primary"}),e.jsx(w,{type:"button",label:"Save Draft",variant:"secondary",onClick:()=>console.log("Save draft")})]})]})})}},x={args:{onSubmit:()=>{}},render:()=>{const t=async s=>{alert(`Form submitted! Check console for detailed logs.

Data: ${JSON.stringify(s,null,2)}`)},l=[{value:"us",label:"United States"},{value:"ca",label:"Canada"},{value:"uk",label:"United Kingdom"},{value:"de",label:"Germany"},{value:"fr",label:"France"}],i=[{value:"reading",label:"Reading"},{value:"gaming",label:"Gaming"},{value:"cooking",label:"Cooking"},{value:"sports",label:"Sports"},{value:"music",label:"Music"}],o=[{value:"personal",label:"Personal Account",description:"For individual use"},{value:"business",label:"Business Account",description:"For teams and organizations"},{value:"enterprise",label:"Enterprise Account",description:"For large organizations"}];return e.jsxs("div",{className:"max-w-4xl mx-auto p-6",children:[e.jsxs("div",{className:"mb-6",children:[e.jsx("h2",{className:"text-2xl font-bold mb-2",children:"User Registration Form"}),e.jsx("p",{className:"text-gray-600",children:"This showcases Form molecule orchestrating atoms and molecules from our library"}),e.jsx(S,{variant:"warning",className:"mt-2",children:"Molecule Component"})]}),e.jsxs(m,{onSubmit:t,layout:"grid",gridColumns:2,spacing:"lg",submitText:"Create Account",loadingText:"Creating account...",children:[e.jsx("div",{className:"col-span-2",children:e.jsxs("h3",{className:"text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2",children:[e.jsx(r,{className:"w-5 h-5"}),"Personal Information"]})}),e.jsx(a,{name:"firstName",label:"First Name",icon:r,placeholder:"John",tooltip:"Your given name",required:!0}),e.jsx(a,{name:"lastName",label:"Last Name",icon:r,placeholder:"Doe",tooltip:"Your family name",required:!0}),e.jsx(a,{name:"email",label:"Email Address",type:"email",icon:c,placeholder:"john@example.com",tooltip:"We'll use this for login and notifications",required:!0}),e.jsx(a,{name:"phone",label:"Phone Number",type:"tel",icon:q,placeholder:"+1 (555) 123-4567",tooltip:"For account verification and support"}),e.jsxs("div",{className:"col-span-2 mt-6",children:[e.jsx(d,{}),e.jsxs("h3",{className:"text-lg font-semibold text-gray-900 my-4 flex items-center gap-2",children:[e.jsx(T,{className:"w-5 h-5"}),"Address Information"]})]}),e.jsx("div",{className:"col-span-2",children:e.jsx(a,{name:"address",label:"Street Address",icon:T,placeholder:"123 Main Street",tooltip:"Your full street address",required:!0})}),e.jsx(a,{name:"city",label:"City",placeholder:"New York",required:!0}),e.jsx(me,{name:"country",label:"Country",placeholder:"Select country",options:l,required:!0}),e.jsxs("div",{className:"col-span-2 mt-6",children:[e.jsx(d,{}),e.jsxs("h3",{className:"text-lg font-semibold text-gray-900 my-4 flex items-center gap-2",children:[e.jsx(D,{className:"w-5 h-5"}),"Account Preferences"]})]}),e.jsx("div",{className:"col-span-2",children:e.jsx(le,{name:"accountType",label:"Account Type",options:o,required:!0})}),e.jsx("div",{className:"col-span-2",children:e.jsx(ce,{name:"hobbies",label:"Interests & Hobbies",description:"Select all that apply (optional)",options:i})}),e.jsx("div",{className:"col-span-2",children:e.jsx(ne,{name:"bio",label:"Bio",placeholder:"Tell us a bit about yourself...",rows:3,tooltip:"Optional: Share your background or interests"})}),e.jsxs("div",{className:"col-span-2 mt-6",children:[e.jsx(d,{}),e.jsxs("h3",{className:"text-lg font-semibold text-gray-900 my-4 flex items-center gap-2",children:[e.jsx(D,{className:"w-5 h-5"}),"Notification Settings"]})]}),e.jsxs("div",{className:"col-span-2 space-y-4",children:[e.jsx(u,{name:"emailNotifications",label:"Email Notifications",description:"Receive updates and news via email",defaultChecked:!0}),e.jsx(u,{name:"smsNotifications",label:"SMS Notifications",description:"Receive important alerts via SMS"}),e.jsx(u,{name:"marketingEmails",label:"Marketing Communications",description:"Receive product updates and special offers"})]}),e.jsxs("div",{className:"col-span-2 mt-6",children:[e.jsx(d,{}),e.jsx("div",{className:"pt-4",children:e.jsx(u,{name:"agreeToTerms",label:"I agree to the Terms of Service and Privacy Policy",description:"Required to create an account",required:!0})})]})]})]})}},y={args:{onSubmit:()=>{}},render:()=>{var s;const[t,l]=C.useState({firstName:"John",lastName:"Doe",email:"john@example.com",status:"online"}),i=async n=>{l(F=>({...F,...n})),console.log("Profile updated:",n)},o=(n,F)=>{l(re=>({...re,[n]:F}))};return e.jsxs("div",{className:"max-w-2xl mx-auto p-6",children:[e.jsx("h2",{className:"text-2xl font-bold mb-6",children:"Profile Editor"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-8",children:[e.jsxs("div",{className:"bg-gray-50 p-6 rounded-lg",children:[e.jsx("h3",{className:"text-lg font-semibold mb-4",children:"Live Preview"}),e.jsx(ie,{avatarSrc:"https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",name:`${t.firstName} ${t.lastName}`.trim(),username:((s=t.email)==null?void 0:s.split("@")[0])||"username",status:t.status,size:"lg",layout:"vertical",className:"justify-center"}),e.jsxs("div",{className:"mt-4 space-y-2",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(S,{variant:"info",size:"sm",children:"Name"}),e.jsx("span",{className:"text-sm",children:`${t.firstName} ${t.lastName}`.trim()||"Not set"})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(S,{variant:"warning",size:"sm",children:"Email"}),e.jsx("span",{className:"text-sm",children:t.email||"Not set"})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(S,{variant:"success",size:"sm",children:"Status"}),e.jsx("span",{className:"text-sm capitalize",children:t.status})]})]})]}),e.jsx("div",{children:e.jsxs(m,{onSubmit:i,onFieldChange:o,initialValues:t,validateOnChange:!0,submitText:"Update Profile",spacing:"md",children:[e.jsx(a,{name:"firstName",label:"First Name",icon:r,placeholder:"John",required:!0}),e.jsx(a,{name:"lastName",label:"Last Name",icon:r,placeholder:"Doe",required:!0}),e.jsx(a,{name:"email",label:"Email",type:"email",icon:c,placeholder:"john@example.com",required:!0}),e.jsx(le,{name:"status",label:"Status",options:[{value:"online",label:"Online"},{value:"offline",label:"Offline"},{value:"away",label:"Away"},{value:"busy",label:"Busy"}],required:!0})]})})]})]})}},N={args:{onSubmit:()=>{},onFieldChange:()=>{}},render:t=>{const l=async(o,s)=>{t.onSubmit(o,s),console.log("Contact form submitted:",o),alert(`Message sent from ${o.firstName} ${o.lastName}!`)},i=(o,s,n)=>{t.onFieldChange({fieldName:o,fieldValue:s,formValues:n})};return e.jsxs("div",{className:"max-w-2xl mx-auto p-6",children:[e.jsx("h2",{className:"text-2xl font-bold mb-6",children:"Contact Us (with Actions Logging)"}),e.jsxs(m,{onSubmit:l,onFieldChange:i,layout:"grid",gridColumns:2,spacing:"lg",showSubmitButton:!1,children:[e.jsx(a,{name:"firstName",label:"First Name",icon:r,placeholder:"John",tooltip:"Your given name",required:!0}),e.jsx(a,{name:"lastName",label:"Last Name",icon:r,placeholder:"Doe",tooltip:"Your family name",required:!0}),e.jsx(a,{name:"email",label:"Email",icon:c,type:"email",placeholder:"john@example.com",tooltip:"We'll respond to this email",required:!0}),e.jsx(a,{name:"phone",label:"Phone",icon:q,type:"tel",placeholder:"+1 (555) 123-4567",tooltip:"Optional: For urgent matters"}),e.jsx("div",{className:"col-span-2",children:e.jsx(oe,{label:"Message",name:"message",tooltip:"Tell us how we can help you",placeholder:"Your message here...",required:!0})}),e.jsx("div",{className:"col-span-2 flex justify-end",children:e.jsx(w,{type:"submit",label:"Send Message",variant:"primary",size:"md",className:"px-8"})})]})]})}};var M,I,A;p.parameters={...p.parameters,docs:{...(M=p.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    onSubmit: () => {}
  },
  render: () => {
...
}`,...(V=(z=g.parameters)==null?void 0:z.docs)==null?void 0:V.source}}};var $,J,W;v.parameters={...v.parameters,docs:{...($=v.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => {
...
}`,...(W=(J=v.parameters)==null?void 0:J.docs)==null?void 0:W.source}}};var Y,_,G;f.parameters={...f.parameters,docs:{...(Y=f.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: () => {
...
}`,...(G=(_=f.parameters)==null?void 0:_.docs)==null?void 0:G.source}}};var H,K,Z;x.parameters={...x.parameters,docs:{...(H=x.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    onSubmit: () => {}
  },
  render: () => {
...
}`,...(se=(te=N.parameters)==null?void 0:te.docs)==null?void 0:se.source}}};const $e=["BasicForm","WithValidation","GridLayout","HorizontalLayout","ControlledForm","CustomSubmitButton","ComponentShowcase","WithUserPreview","ContactFormWithActions"];export{p as BasicForm,x as ComponentShowcase,N as ContactFormWithActions,v as ControlledForm,f as CustomSubmitButton,b as GridLayout,g as HorizontalLayout,y as WithUserPreview,h as WithValidation,$e as __namedExportsOrder,Ve as default};
