import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{r as I,R as f}from"./iframe-CeuOv4tS.js";import{c as H}from"./clsx-B-dksMZM.js";import{B as e}from"./Button-BaSNKDgs.js";import{I as P,X as V}from"./IconButton-BVm-gK0T.js";import"./createLucideIcon-zYllTUnP.js";const i=({children:o,content:R,className:q,delay:E=150,id:r,position:C="top"})=>{const[p,c]=I.useState(!1);let d;const m=()=>{d=setTimeout(()=>c(!0),E)},u=()=>{clearTimeout(d),c(!1)},D={top:"bottom-full mb-2 left-1/2 transform -translate-x-1/2",bottom:"top-full mt-2 left-1/2 transform -translate-x-1/2",left:"right-full mr-2 top-1/2 transform -translate-y-1/2",right:"left-full ml-2 top-1/2 transform -translate-y-1/2"};return t.jsxs("div",{className:"relative inline-block",onMouseEnter:m,onMouseLeave:u,onFocus:m,onBlur:u,children:[f.isValidElement(o)&&f.cloneElement(o,{"aria-describedby":p?r:void 0}),p&&t.jsx("div",{id:r,role:"tooltip",className:H("absolute z-10 px-2 py-1 rounded bg-gray-800 text-white text-xs whitespace-nowrap shadow-lg",D[C],q),children:R})]})};i.__docgenInfo={description:`Tooltip atom component.
