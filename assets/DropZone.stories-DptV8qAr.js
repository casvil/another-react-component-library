import{j as f}from"./jsx-runtime-D_zvdyIk.js";import{e as Xe,r as a}from"./iframe-BCzmj9Vo.js";import{c as C}from"./clsx-B-dksMZM.js";import{c as Qe}from"./createLucideIcon-CebC0jUa.js";import{a as er,C as rr}from"./circle-x-BZqqCVLZ.js";import{u as sr}from"./useStableId-gMyTOkxf.js";import{D as tr}from"./classes-DL16wGMG.js";import{T as se}from"./Text-BDDRxkGi.js";/**
 * @license lucide-react v0.515.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const or=[["path",{d:"M12 3v12",key:"1x0j5s"}],["path",{d:"m17 8-5-5-5 5",key:"7q97r8"}],["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}]],te=Qe("upload",or),ar=(s,r)=>s?te:r==="success"?er:r==="error"?rr:te,nr=(s,r,t)=>s?"text-gray-400":r==="success"?"text-green-500":r==="error"?"text-red-500":t?"text-blue-500":"text-gray-500",ir=(s,r,t)=>s?"border-gray-200":r==="success"?"border-green-300":r==="error"?"border-red-300":t?"border-blue-400 border-solid":"border-gray-300 border-dashed",lr=(s,r,t)=>s?"bg-gray-50":r==="success"?"bg-green-50":r==="error"?"bg-red-50":t?"bg-blue-50":"bg-white hover:bg-gray-50",cr=(s,r)=>s?"muted":r==="success"?"success":r==="error"?"error":"primary",F=s=>{const r=new DataTransfer;return s.forEach(t=>r.items.add(t)),r.files},B=Xe.memo(a.forwardRef(({onDrop:s,onDropRejected:r,accept:t="*/*",multiple:x=!1,maxFiles:V=10,maxSize:Z=10*1024*1024,minSize:R=0,title:W,description:J,variant:g="default",disabled:o=!1,loading:n=!1,size:u="md",className:_,contentClassName:K,iconClassName:Y,"aria-label":Oe,"aria-describedby":$e,...Be},Ve)=>{const H=`${sr()}-description`,b=a.useRef(null),[h,L]=a.useState(!1),[,E]=a.useState(0),l=a.useMemo(()=>({accept:t,maxFiles:V,maxSize:Z,minSize:R,acceptedTypes:t!=="*/*"&&t!=="*"?t.split(",").map(e=>e.trim().toLowerCase()):null}),[t,V,Z,R]),X=a.useCallback(e=>{var Q;const i=[],p=[];let m;if(e.length>l.maxFiles)return m=`Too many files. Maximum ${l.maxFiles} file${l.maxFiles===1?"":"s"} allowed.`,{valid:F([]),invalid:F(Array.from(e)),error:m};for(let $=0;$<e.length;$++){const c=e[$];if(c.size>l.maxSize){p.push(c),m=`File "${c.name}" is too large. Maximum size: ${(l.maxSize/(1024*1024)).toFixed(1)}MB`;continue}if(c.size<l.minSize){p.push(c),m=`File "${c.name}" is too small. Minimum size: ${(l.minSize/1024).toFixed(1)}KB`;continue}if(l.acceptedTypes){const ee=c.type.toLowerCase(),re="."+((Q=c.name.split(".").pop())==null?void 0:Q.toLowerCase());if(!l.acceptedTypes.some(D=>{if(D.includes("/*")){const He=D.split("/")[0];return ee.startsWith(He+"/")}return ee===D||re===D})){p.push(c),m=`File type "${c.type||re}" not accepted. Accepted types: ${l.accept}`;continue}}i.push(c)}return{valid:F(i),invalid:F(p),error:m}},[l]),v=a.useCallback(e=>{if(e.length===0)return;const{valid:i,invalid:p,error:m}=X(e);i.length>0&&s&&s(i),p.length>0&&m&&r&&r(p,m)},[X,s,r]),Ze=a.useCallback(e=>{const i=e.target.files;i&&v(i),b.current&&(b.current.value="")},[v]),G=a.useCallback(()=>{var e;o||n||(e=b.current)==null||e.click()},[o,n]),Re=a.useCallback(e=>{e.preventDefault(),e.stopPropagation(),!(o||n)&&(E(i=>i+1),e.dataTransfer.items&&e.dataTransfer.items.length>0&&L(!0))},[o,n]),We=a.useCallback(e=>{e.preventDefault(),e.stopPropagation(),E(i=>{const p=i-1;return p===0&&L(!1),p})},[]),Je=a.useCallback(e=>{if(e.preventDefault(),e.stopPropagation(),o||n){e.dataTransfer.dropEffect="none";return}e.dataTransfer.dropEffect="copy"},[o,n]),_e=a.useCallback(e=>{if(e.preventDefault(),e.stopPropagation(),L(!1),E(0),o||n)return;const i=e.dataTransfer.files;v(i)},[o,n,v]),Ke=a.useCallback(e=>{(e.key==="Enter"||e.key===" ")&&!o&&!n&&(e.preventDefault(),G())},[o,n,G]),y=a.useMemo(()=>({icon:ar(n,g),iconColor:nr(o,g,h),borderColor:ir(o,g,h),backgroundColor:lr(o,g,h),textColor:cr(o,g)}),[o,g,h,n]),d=a.useMemo(()=>tr,[]),A=a.useMemo(()=>({title:W||(x?"Drop files here":"Drop file here"),description:J||`Click to select ${x?"files":"a file"} or drag and drop${t!=="*/*"?` (${t})`:""}`}),[W,x,J,t]),O=a.useMemo(()=>({dropZone:C("flex flex-col items-center justify-center text-center border-2 transition-all duration-200 cursor-pointer",d.height[u],d.padding[u],d.borderRadius[u],y.borderColor,y.backgroundColor,o&&"cursor-not-allowed opacity-60",n&&"cursor-wait",_),content:C("flex flex-col items-center justify-center",d.gap[u],K),icon:C(d.icon[u],y.iconColor,n&&"animate-pulse",Y)}),[d,u,y,o,n,_,K,Y]),Ye=y.icon;return f.jsxs("div",{ref:Ve,role:"button",tabIndex:o?-1:0,"aria-label":Oe||A.title,"aria-describedby":$e||H,className:O.dropZone,onClick:G,onDragEnter:Re,onDragLeave:We,onDragOver:Je,onDrop:_e,onKeyDown:Ke,...Be,children:[f.jsx("input",{ref:b,type:"file",accept:t,multiple:x,onChange:Ze,className:"sr-only",tabIndex:-1,"aria-hidden":"true"}),f.jsxs("div",{className:O.content,children:[f.jsx(Ye,{size:d.iconValues[u],className:O.icon,"aria-hidden":"true"}),f.jsxs("div",{className:"space-y-1",children:[f.jsx(se,{variant:"body",weight:"medium",color:y.textColor,className:d.text[u].title,children:A.title}),f.jsx(se,{variant:"small",color:o?"muted":"secondary",id:H,className:C("max-w-xs",d.text[u].description),children:A.description})]})]})]})}));B.displayName="DropZone";B.__docgenInfo={description:`DropZone molecule component. A file upload area that supports both drag & drop
...
}`,...(be=(xe=I.parameters)==null?void 0:xe.docs)==null?void 0:be.source}}};var he,ve,De;z.parameters={...z.parameters,docs:{...(he=z.parameters)==null?void 0:he.docs,source:{originalSource:`{
  args: {
...
}`,...(De=(ve=z.parameters)==null?void 0:ve.docs)==null?void 0:De.source}}};var Ce,Fe,Se;k.parameters={...k.parameters,docs:{...(Ce=k.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  args: {
    variant: 'success',
