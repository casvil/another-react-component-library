import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{r as l}from"./iframe-DtmuWCxD.js";import{c as i}from"./clsx-B-dksMZM.js";import{L as q}from"./Label-BnpzQARg.js";import{w as F}from"./withFullWidthRoot-KUvJuXNM.js";const x=l.forwardRef(({label:o,labelPosition:y="above",wrapperClassName:h,labelClassName:w,id:N,className:T,...v},C)=>{const S=l.useId(),t=N??S,j=y==="beside"?"flex-row":"flex-col";return r.jsxs("div",{className:i("flex gap-2",j,h),children:[o&&r.jsx(q,{htmlFor:t,className:w,children:o}),r.jsx("textarea",{id:t,ref:C,className:i("resize-none rounded border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500",T),...v})]})});x.__docgenInfo={description:`TextArea molecule component.
