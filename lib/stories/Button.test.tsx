...
describe('Button component', () => {
  ...
  it('renders left icon', () => {
    render(<Button label="Back" icon={<ArrowLeft data-testid="icon-left" />} iconPosition="left" />);
  ...
  it('renders right icon', () => {
    render(<Button label="Next" icon={<ArrowRight data-testid="icon-right" />} iconPosition="right" />);
